...
export const properties = [ 
    ...
    {
	bedRange: "3 beds",
	description: "Experience the pinnacle of luxury living in this exquisite penthouse suite. Perched high above the city skyline, it offers unparalleled views and opulent amenities. Whether you're hosting extravagant soirées in the spacious living area or unwinding in the lavish master suite, this penthouse promises a lifestyle of elegance and indulgence.",
...
export function Card(props) {
    ...
    const {title, image, id, price, address, description, bed , onClick} = props;
...
return (
    <div key={id} >
        ...
        <p>{price}</p>
		<button onClick={()=>{
                handleAddToFavourite()}}>Adauga la favorite</button>
    </div>
)
}